            ...
            \begin{block}{Presented:}
                \begin{itemize}
                    ...
                    \item<1> Vulnerability assessment of a DIFT mechanism against FIA
                        \only<1>{
                            \begin{itemize}
                                ...
                                \item Take into account different fault models adapted from simple to more complex ones to defeat the DIFT and its protections
                            \end{itemize}
                        }
                    ...
                    \item<3> Proposition of 3 lightweight countermeasures:
                        \only<3>{
                            \begin{itemize}
                                \item based on parity codes
                                \item area overhead smaller than 8\%
                                \item no impact on performances
                                \item good efficiency in terms of security
                            \end{itemize}
                        }
                \end{itemize}
            \end{block}
