    ...
    \begin{minipage}[c]{0.55\textwidth}
        \begin{block}{}
            \begin{itemize}
                ...
                \item Protection against software attacks~\cite{BSMCVEJCO-21-acmcsur, HAK-21-acmcsur}% (e.g.: \textit{buffer overflow}, \textit{format string}, \textit{SQL injections}, \ldots)
    ...
    \begin{minipage}[c]{0.4\textwidth}
        \only<2>{
            \begin{figure}
                ...
                \caption{Representation of a Hardware Off-Core DIFT}
                \label{fig:offcore}
            \end{figure}
        }
        \only<3>{
        ...
        \only<4>{
            \begin{figure}
                ...
                \caption{Representation of a Hardware In-Core DIFT}
                \label{fig:incore}
            \end{figure}
        }
    \end{minipage}
