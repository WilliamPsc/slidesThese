...
\begin{frame}{Context: IoT Under Threats}
    ...
    \begin{block}{Threats}
        \begin{itemize}
            ...
            \item Software threats: memory overflow attacks~\cite{CWCBW-00-discex}, code execution, SQL injection, etc
    ...
    \begin{block}{Threats}
        \begin{itemize}
            ...
            \justifying
            \item Network threats: Man-In-The-Middle~\cite{CDL-16-commsurtuto}, jamming~\cite{PZ-22-commsurtuto}, DoS, etc
            \item \textbf{\textcolor{red}{Software threats}}: memory overflow attacks~\cite{CWCBW-00-discex}, code execution, SQL injection, etc
            \item \textbf{\textcolor{red}{Hardware threats}}: Reverse Engineering, Side-Channel Attacks~\cite{DM-21-appiot}, \underline{Fault Injection Attacks}~\cite{BCNTW-06-procieee}
        \end{itemize}
    \end{block}
    }
