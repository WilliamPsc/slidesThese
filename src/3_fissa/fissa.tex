...
\begin{frame}{Fault Injection Simulation for Security Assessment (FISSA)}
    \begin{block}{Presentation}
        \begin{itemize}
            \item Open-Source tool~\footnote[frame]{\fullcite{fissa}}.
            ...
            \item Published in DSD 2024~\cite{PLG-24-dsd}.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{FISSA — Supported Fault Models}
    \begin{table}
        ...
        \begin{tabular}{@{}rccc@{}}
            \toprule
            Fault model                                                        & \begin{tabular}[c]{@{}c@{}}Number of\\ target\end{tabular} & \begin{tabular}[c]{@{}c@{}}Number of\\ cycles\end{tabular} & Target size \\
            \midrule
            Set to 0                                                           & 1                                                          & 1                                                          & all         \\
            Set to 1                                                           & 1                                                          & 1                                                          & all         \\
