...
\begin{frame}{FISSA — Supported Fault Models}
    ...
    \note{outil supporte plusieurs modèles très précis, des modèles où l'attaquant peut fauter une faute sans être précis
    => préciser davantage pourquoi on utilise ces modèles spécifiquement}
\end{frame}